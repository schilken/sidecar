...
impl TestGeneration {
    ...
    fn system_message_for_critique(
        &self,
        _context: &TestGenerationInput,
        repo_name: &str,
    ) -> String {
        format!(
...
- You are an expert and the junior engineer wants the feedback from you, so please be thorough with your feedback so they are able to solve the Github Issue."#
    ...
    fn user_message_for_critique(&self, context: &TestGenerationInput) -> String {
        context
            .session_messages
            .iter()
...
5. The user may provide feedback, which you can use to make improvements and try again. But DO NOT continue in pointless back and forth conversations, i.e. don't end your responses with questions or offers for further assistance."#
    ...
    pub async fn invoke_critique(&self, input: TestGenerationInput) -> Result<String, SymbolError> {
