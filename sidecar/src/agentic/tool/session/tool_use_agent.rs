...
- When using execute_command tool to run python scripts, only use the relative file path and never absolute. This means all your file paths in execute_command should be relative.
